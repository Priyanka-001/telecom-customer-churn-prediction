...
df_1=pd.read_csv("customer-churn-data.csv")
...
def predict():
    ...
    model = pickle.load(open("model-rf.sav", "rb"))
    ...
    new_df__dummies = pd.get_dummies(df_2[['gender', 'MultipleLines', 'InternetService', 'OnlineSecurity', 'OnlineBackup',
